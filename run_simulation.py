...
parser.add_argument("--n-cells", type=int, default=5,
                    help="number of cells to start with")
parser.add_argument("--perc-res", type=int, default=200,
                    help="the number of steps to take")
parser.add_argument("--n-children", type=int, default=2000,
                    help="the number of children each cell produces")
parser.add_argument("--n-filter", type=int, default=200,
